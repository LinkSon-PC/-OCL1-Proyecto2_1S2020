    ...
    var parser = { trace: function trace() { },
        ...
        performAction: function anonymous(yytext, yyleng, yylineno, yy, yystate /* action[1] */, $$ /* vstack */, _$ /* lstack */) {
            ...
            switch (yystate) {
                ...
                case 3:
                    this.$ = new Tree($$[$0 - 1]);
                    console.log("CREACION DEL ARBOL");
                    return this.$;
                    break;
                case 4:
                    this.$ = new Tree($$[$0]);
                ...
                case 100:
                    ...
                    CErrores.Errores.add(new CNodoError.NodoError("Sintactico", "error::=       " + yytext + "    Columna:" + this._$.first_column, this._$.first_line));
                    break;
                case 13:
                case 60:
                case 61:
            ...
            performAction: function anonymous(yy, yy_, $avoiding_name_collisions, YY_START) {
                ...
                switch ($avoiding_name_collisions) {
                    ...
                    case 7:
                        ...
                        break;
                    case 8:
                        console.log("STRING QUEMADO ");
                        return 85;
                        break;
                    case 9:
                        console.log("comentario Bloque reconocido");
