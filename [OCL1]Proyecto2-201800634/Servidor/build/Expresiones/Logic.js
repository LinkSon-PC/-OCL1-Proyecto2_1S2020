...
class Logic extends Node_1.Node {
    ...
    execute(table, tree) {
        GraficaArbolAts_1.GraficaArbolAts.add("<li data-jstree='{ \"opened\" : true }'>LOGIC\n");
        GraficaArbolAts_1.GraficaArbolAts.add("<ul>\n");
        this.leftOperator.execute(table, tree);
        if (this.Operator != null) {
            GraficaArbolAts_1.GraficaArbolAts.add("<li data-jstree='{ \"opened\" : true }'>OperadorLogico</li>\n");
        }
